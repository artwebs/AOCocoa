...
//  WebServer
//
//  Created by artwebs on 14/11/27.
...
*/
public class SimpleSocket<T: SocketAddress> {
...
extension SimpleSocket { // Socket Flags
...
extension SimpleSocket { // Socket Options
...
extension SimpleSocket: Printable {
...
extension SimpleSocket: BooleanType {
