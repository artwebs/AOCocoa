...
static void copy_picture(MpegPicture *dst, MpegPicture *src)
{
    *dst = *src;
}
...
static void free_picture(MpegEncContext *s, MpegPicture *pic)
{
    int i;
...
int MPV_common_init(MpegEncContext *s)
{
    ...
    s->picture= (struct MpegPicture *)av_mallocz( MAX_PICTURE_COUNT * sizeof(MpegPicture));
...
int MPV_frame_start(MpegEncContext *s, AVCodecContext *avctx)
{
    ...
    if( alloc_picture(s, (MpegPicture*)pic, 0) < 0)
        return -1;

    s->current_picture_ptr= (MpegPicture*)pic;
